...
export default function NavMenu({ menuOpen, toggleMenu, lightTheme }) {
  const styling = 'transition duration-1000 ease-in-out'
  return !menuOpen ? <Fragment>
    {
      lightTheme ? 
        <svg className={styling} onClick={()=> toggleMenu(!menuOpen)} width="25" height="18" viewBox="0 0 25 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {
        lightTheme ? 
          <svg className={styling} onClick={()=> toggleMenu(!menuOpen)} width="25" height="18" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
